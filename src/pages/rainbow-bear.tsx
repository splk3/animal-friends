...
const RainbowBearPage: React.FC = () => {
  return (
    <PageTemplate
      pageTitle="🌈🐻 Rainbow Bear - Colorful Bears"
      funFact="🌈 Fun Fact: Rainbow Bears create colorful displays wherever they go! Their presence makes the environment more vibrant and joyful!"
    >
      <p className="text-lg text-gray-700 mb-6">
              The Rainbow Bear combines the characteristics of bears with stunning 
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Needs similar environment to regular bears with appropriate space, 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Same nutritional needs as regular bears. Balanced diet maintains 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Same personality as regular bears. The rainbow colors just make them 
...
export default RainbowBearPage

export const Head: HeadFC = () => <title>Rainbow Bear - Animal Friends</title>
