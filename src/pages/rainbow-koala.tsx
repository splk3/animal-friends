...
const RainbowKoalaPage: React.FC = () => {
  return (
    <Layout pageTitle="🌈🐨 Rainbow Koala - Colorful Koalas" showBackButton={true}>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Needs similar environment to regular koalas with appropriate space, 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Same nutritional needs as regular koalas. Balanced diet maintains 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Same personality as regular koalas. The rainbow colors just make them 
...
export default RainbowKoalaPage

export const Head: HeadFC = () => <title>Rainbow Koala - Animal Friends</title>
