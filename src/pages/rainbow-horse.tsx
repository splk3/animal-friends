...
const RainbowHorsePage: React.FC = () => {
  return (
    <PageTemplate
      pageTitle="🌈🐴 Rainbow Horse - Colorful Horses"
      funFact="🌈 Fun Fact: Rainbow Horses create colorful displays wherever they go! Their presence makes the environment more vibrant and joyful!"
    >
      <p className="text-lg text-gray-700 mb-6">
              The Rainbow Horse combines the characteristics of horses with stunning 
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Needs similar environment to regular horses with appropriate space, 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Same nutritional needs as regular horses. Balanced diet maintains 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Same personality as regular horses. The rainbow colors just make them 
...
export default RainbowHorsePage

export const Head: HeadFC = () => <title>Rainbow Horse - Animal Friends</title>
