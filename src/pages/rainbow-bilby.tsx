...
const RainbowBilbyPage: React.FC = () => {
  return (
    <PageTemplate
      pageTitle="🌈🐭 Rainbow Bilby - Colorful Bilbies"
      funFact="🌈 Fun Fact: Rainbow Bilbies create colorful displays wherever they go! Their presence makes the environment more vibrant and joyful!"
    >
