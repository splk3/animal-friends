...
const RainbowDeerPage: React.FC = () => {
  return (
    <PageTemplate
      pageTitle="🌈🦌 Rainbow Deer - Colorful Deer"
      funFact="🌈 Fun Fact: Rainbow Deer create colorful displays wherever they go! Their presence makes the environment more vibrant and joyful!"
    >
...
export default RainbowDeerPage

export const Head: HeadFC = () => <title>Rainbow Deer - Animal Friends</title>
