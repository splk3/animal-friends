...
const RainbowCapybaraPage: React.FC = () => {
  return (
    <PageTemplate
      pageTitle="🌈🦫 Rainbow Capybara - Colorful Capybaras"
      funFact="🌈 Fun Fact: Rainbow Capybaras create colorful displays wherever they go! Their presence makes the environment more vibrant and joyful!"
    >
      <p className="text-lg text-gray-700 mb-6">
              The Rainbow Capybara combines the characteristics of capybaras with stunning 
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Needs similar environment to regular capybaras with appropriate space, 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Same nutritional needs as regular capybaras. Balanced diet maintains 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Same personality as regular capybaras. The rainbow colors just make them 
...
export default RainbowCapybaraPage

export const Head: HeadFC = () => <title>Rainbow Capybara - Animal Friends</title>
