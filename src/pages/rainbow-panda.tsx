...
const RainbowPandaPage: React.FC = () => {
  return (
    <PageTemplate
      pageTitle="🌈🐼 Rainbow Panda - Colorful Pandas"
      funFact="🌈 Fun Fact: Rainbow Pandas create colorful displays wherever they go! Their presence makes the environment more vibrant and joyful!"
    >
      <p className="text-lg text-gray-700 mb-6">
              The Rainbow Panda combines the characteristics of pandas with stunning 
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Needs similar environment to regular pandas with appropriate space, 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Same nutritional needs as regular pandas. Balanced diet maintains 
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Same personality as regular pandas. The rainbow colors just make them 
...
export default RainbowPandaPage

export const Head: HeadFC = () => <title>Rainbow Panda - Animal Friends</title>
